		...
		\subsubsection{Shared phenomena}
			...
			Controlled by the \textbf{machine}\newline\newline
					\begin{tabular}{|c|l|}
						...
						\rowcolor[HTML]{DCDCDC} 
						\textbf{SP1} & 
						The customer is notified that his turn is coming \\ \hline
			...
			Controlled by the \textbf{world}\newline\newline
					\begin{tabular}{|c|l|}
						\hline
						\rowcolor[HTML]{DCDCDC} 
						\textbf{SP4} & The customer enters the store scanning his QR code \\ \hline
		...
		\subsubsection{Mapping}
			...
			\begin{tabular}{|c|c|c|}
				...
				\textbf{G4} 
					...
					&
					\begin{minipage}[t]{9cm}
						R1, R2, R3.a, R3.b, R4, R5, R6, R7, R9, R10, R11, R13, R14, R15, R16, R17, R18, R20 \\
					\end{minipage}
				\\ \hline				
				\textbf{G5} 
					& 
