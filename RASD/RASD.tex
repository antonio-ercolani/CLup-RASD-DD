...
\newline\newline
	...
	\begin{tabular}{|c|l|}
		...
		\textbf{08/01/2021} & \begin{minipage}[t]{13cm}
			2.0
			\begin{itemize}
				\item Update in section 1.3: Added "Totem" definition
				\item Update in section 3.1.3: Position service software module added
				\item Updated section 6 with references that were missing
				\item Various typing errors fixed
				\item Few indentation fixes  \\
			\end{itemize}
		\end{minipage}  \\ \hline
		\rowcolor[HTML]{DCDCDC} 
		\end{tabular}
	...
	\section{Specific requirements}
		...
		This section presents several use cases that show the typical patterns of the users interaction with the system.
			...
			\begin{tabular}{|c|l|}
				...
				\textbf{Exceptions} & 
				\begin{minipage}[t]{10cm}
					The system is not able to retrieve the GPS position of the costumer, therefore the alert mechanism will be disabled \\
				\end{minipage}  \\ \hline
			\end{tabular}
			\bigskip
			\newline
