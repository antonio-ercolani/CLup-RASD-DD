	...
	\section{Specific requirements}
		...
		\subsection{Use Cases}
			...
			\item{\textbf{Delete Visit}}
				...
				\textbf{Events Flow} & 
					\begin{minipage}[t]{10cm}
						...
						\item The user saves his operation
						\end{enumerate}
						\end{minipage}
					\\ \hline
				\textbf{Exit Conditions} & \makecell[l]{The user has successfully deleted his scheduled visit and the system has correctly updated the line to let the queue of the store proceed.} \\ \hline
				\textbf{Exceptions} & \makecell[l]{None} \\ \hline
				\end{tabular}
				\newline
				\newline
			...
			\item{\textbf{Physical Queuing}}
				...
				\textbf{Events Flow} & 
					\begin{minipage}[t]{10cm}
						...
						\end{minipage}
					\\ \hline
				\textbf{Exit Conditions} & \makecell[l]{The user has the ticket to enter the store and can wait without standing near other people} \\ \hline
				\textbf{Exceptions} & \makecell[l]{If the totem is broken then the store manager will directly handle the physical requests to line up, letting the users enter the store only when the limit of people is not exceeded} \\ \hline
				\end{tabular}
				\newline
				\newline
				\newline
			...
			\item{\textbf{Customer enters/exits the store}}
				...
				\textbf{Actor} & \makecell[l]{User} \\ \hline
				\textbf{Entry Conditions} & \makecell[l]{The user is queuing from home} \\ \hline
				\textbf{Events Flow} & 
					\begin{minipage}[t]{10cm}
						\setlist[enumerate]{label={\arabic*.}, ref={\arabic*}}
						\begin{enumerate}
						\item The user gets a notification to approach the store
						...
						\item The system updates the queue (AND SENDS A FINAL NOTIFICATION TO THE USER?????)
						\end{enumerate}
						\end{minipage}
					\\ \hline
				\textbf{Exit Conditions} & \makecell[l]{The system has correctly updated the queue of the store and is ready to allow a new user join the store.} \\ \hline
				\textbf{Exceptions} & \makecell[l]{If the customer arrives at the store and his ticket is not valid anymore to enter the store (the validity of his QR code has expired) he will have to reschedule from the beginning his visit to the store} \\ \hline
				\end{tabular}
				\newline
				\newline
				\newline
			...
			\item{\textbf{Build Statistics / Preferences}}
				...
				\textbf{Events Flow} & 
					\begin{minipage}[t]{10cm}
						...
						\end{minipage}
					\\ \hline
				\textbf{Exit Conditions} & \makecell[l]{The user can see what are his favourite products and the average time he usually spends inside the stores} \\ \hline
				\textbf{Exceptions} & \makecell[l]{None} \\ \hline
				\end{tabular}
				\newline
				\newline
