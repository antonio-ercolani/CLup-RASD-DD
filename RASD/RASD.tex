	...
	\section{Specific requirements}
		...
		\subsubsection{Mapping}
			...
			\begin{tabular}{|c|c|c|}
				...
				\textbf{G4} 
					...
					&
					\begin{minipage}[t]{9cm}
						R1, R2, R3.a, R3.b, R3.c, R4, R5, R6, R7, R9, R10, R11, R13, R14, R15, R16, R17, R18, R20 \\
					\end{minipage}
				\\ \hline				
				\textbf{G5} 
					& 
		...
		\subsection{Use Cases}
			...
			\item{\textbf{Physical Queuing}}
				...
				\textbf{Goals} & \makecell[l]{TODO NESSUN MAPPING} \\ \hline
				...
				\textbf{Events Flow} & 
					\begin{minipage}[t]{10cm}
						...
						\item The system checks the availability of the physical spots to queue outside the store
				...
				\textbf{Exceptions} & 
					\begin{minipage}[t]{10cm}
					If there are no available spots in the physical queue, then the costumer will get a not valid ticket. He will need to try to join the queue later or try to line-up through the app. \\
					\end{minipage}  \\ \hline
				\end{tabular}
				\newline
				\newline
			...
			\item{\textbf{Build Statistics / Preferences}}
				...
				\textbf{Events Flow} & 
					\begin{minipage}[t]{10cm}
						\setlist[enumerate]{label={\arabic*.}, ref={\arabic*}}
						\begin{enumerate}
						\item The user wants to know his product preferences or average permanence into a store
						\item The system updates the user's statistics (the periodical update might have not taken into account the last bookings)
